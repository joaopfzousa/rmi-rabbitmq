...
public class ObserverGuiClient extends javax.swing.JFrame {
    ...
    private void initContext(String args[]) {
        try {
            ...
            //Lookup service
            this.chatRI=(ChatRI)lookupService();
    ...
    private void initObserver(String args[]) {
        try {
            ...
            observer=new ObserverImpl(username, this, this.chatRI);
        } catch (Exception e) {
    ...
    private Remote lookupService() {
        try {
            ...
            if (registry != null) {
                ...
                chatRI=(ChatRI) registry.lookup(serviceUrl);
            } else {
    ...
    private void jButtonSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSendActionPerformed
        ...
        try {
            ...
            this.observer.chatRI.setState(s);
